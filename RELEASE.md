...
Validation: TypeScript checks, all 192 frontend tests, all 1,621 Rust tests, and the production renderer build passed. Four optional platform/performance checks remain skipped. Coverage includes complete file comparisons, read-only copy/refresh, proxy controls, legacy settings, exit handling, global pricing, and automatic Copilot protocol compatibility. The Windows pipeline also builds the MSI before release.
